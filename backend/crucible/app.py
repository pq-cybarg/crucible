    ...
    def avatar_render_png(expression: str = "neutral", blend: str | None = None,
        ...
        if use_hair:
            ...
            if _lash is not None:
                below_img.alpha_composite(_lash)              # in the eye box → squashes WITH the eye border
            if "eyes" not in _hidden:
                # eye closes by a CENTRED squash of the eye box (border lines squeeze together, sides compress).
